/**
 * Smoke-test: extractFrames(15) + tagChunk via Anthropic Claude.
 * Set ANTHROPIC_API_KEY in repo-root .env (see .env.example).
 *
...
console.log("Calling tagChunk (Anthropic Claude)…");
