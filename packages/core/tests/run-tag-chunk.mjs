/**
 * Smoke-test: extractFrames(15) + tagChunk via OpenAI GPT-4o mini.
 * Set OPENAI_API_KEY in repo-root .env (see .env.example).
 *
...
console.log("Calling tagChunk (OpenAI GPT-4o mini)…");
